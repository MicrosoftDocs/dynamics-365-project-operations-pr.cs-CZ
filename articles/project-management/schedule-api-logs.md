...
description: Tento článek poskytuje informace a ukázky, které vám pomohou používat protokoly plánování projektu ke sledování selhání souvisejících se službou Plánování projektu a rozhraními API plánování projektu.
author: ruhercul
ms.date: 11/30/2021
ms.topic: article
