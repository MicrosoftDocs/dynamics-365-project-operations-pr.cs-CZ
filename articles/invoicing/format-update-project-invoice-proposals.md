...
description: Tento článek poskytuje podrobnosti o zpracování faktur vystavených zákazníkům pomocí Project Operations u scénářů založených na zdrojích/položkách, které nejsou na skladě.
author: sigitac
ms.date: 04/12/2021
ms.topic: article
