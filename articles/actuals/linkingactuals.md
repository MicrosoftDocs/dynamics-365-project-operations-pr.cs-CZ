...
description: Toto téma vysvětluje, jak se koncept původu transakcí používá k propojení skutečných hodnot s původními zdrojovými záznamy, jako je záznam času, záznam výdajů nebo protokoly využití materiálu.
author: rumant
ms.date: 03/25/2021
ms.topic: article
ms.prod: ''
