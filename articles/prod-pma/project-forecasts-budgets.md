...
description: Microsoft Dynamics 365 Finance poskytuje k řízení a správě projektů prognózy projektu a rozpočty projektu.
author: Yowelle
ms.date: 10/25/2017
ms.topic: article
ms.prod: ''
...
|   Metoda přidělení       |           Projektové předpovědi            |        Rozpočtování projektů                           |
|---------------------------|------------------------------------------|----------------------------------------------------|
