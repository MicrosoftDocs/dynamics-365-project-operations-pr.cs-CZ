...
description: Tento článek poskytuje informace o aktualizacích kvality, které jsou k dispozici ve verzi Project Operations z října 2021 pro scénáře založené na skladovém materiálu / výrobě.
author: andchoi
ms.date: 11/17/2021
ms.topic: article
ms.prod: ''
