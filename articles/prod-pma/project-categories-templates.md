---
title: Synchronizace kategorií projektových výdajů mezi financemi a operacemi a Project Service Automation
description: Tento článek popisuje šablony a základní úkoly, které se používají k synchronizaci kategorií výdajů mezi aplikací Microsoft Dynamics 365 Finance a Dynamics 365 Project Service Automation.
author: Yowelle
ms.date: 07/20/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9028924"
---
# <a name="synchronize-project-expense-categories-between-finance-and-operations-and-project-service-automation"></a>Synchronizace kategorií projektových výdajů mezi financemi a operacemi a Project Service Automation

[!include[banner](../includes/banner.md)]

Tento článek popisuje šablony a základní úkoly, které se používají k synchronizaci kategorií výdajů mezi aplikací Dynamics 365 Finance a Dynamics 365 Project Service Automation.
