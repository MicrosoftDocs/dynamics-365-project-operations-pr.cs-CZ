...
- Pokud vytváříte novou šablonu, musíte přidat tento sloupec. V Power Query vyberte **Přidat podmíněný sloupec** a zadejte název nového sloupce, například **Model_ID**. Zadejte podmínku kde pro sloupec: Pokud projektový úkol není null, Pak \<zadejte ID modelu předpovědi\> ; Jinak null.
...
[![Mapování šablon](./media/ProjectHourEstimatesMapping.jpg)](./media/ProjectHourEstimatesMapping.jpg)
...
- Pokud vytváříte novou šablonu, musíte přidat tento sloupec. V Power Query vyberte **Přidat podmíněný sloupec** a zadejte název nového sloupce, například **Model_ID**. Zadejte podmínku kde pro sloupec: Pokud ID řádku odhadu není null, Pak \<zadejte ID modelu předpovědi\> ; Jinak null.
...
[![Mapování šablon](./media/ExpenseEstimateTransactionRelationshipsMapping.jpg)](./media/ExpenseEstimateTransactionRelationshipsMapping.jpg)

[![Mapování šablon](./media/ExpenseEstimatesMapping.jpg)](./media/ExpenseEstimatesMapping.jpg)
