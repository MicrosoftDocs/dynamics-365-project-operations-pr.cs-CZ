---
title: Podrobnosti záhlaví pro smlouvy založené na projektu
description: Tento článek poskytuje informace o polích a informace o smlouvách na základě projektu v Project Operations.
author: rumant
ms.date: 10/20/2020
ms.topic: article
...
ms.locfileid: "9824292"
---
# <a name="header-details-for-project-based-contracts"></a>Podrobnosti záhlaví pro smlouvy založené na projektu
...
| Zákazník | Karta **Souhrn** | Odkaz na záznam společnosti nebo účtu zákazníka. Když je smlouva vytvořena z nabídky, zkopíruje se toto pole z odpovídajícího pole záznamu nabídky. | Měna v projektové smlouvě má výchozí hodnotu na základě měny zákazníka. Měnu lze před uložením smlouvy změnit. |
...
| Zaznamenané množství | Detail řádku založeného na projektu | Čas: Všechny časové údaje o skutečných časových nákladech pro roli v projektu, která je namapována na tento řádek smlouvy. Výdaje: Všechna množství pro tuto kategorii výdajů u skutečných výdajových nákladů projektu, která je mapována na tento řádek smlouvy. |
