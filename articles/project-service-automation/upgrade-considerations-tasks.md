...
- [Projektový tým](../developer/entities/msdyn_projectteam.md)
- [Projektový úkol](../developer/entities/msdyn_projecttask.md)
- [Přiřazení zdrojů](../developer/entities/msdyn_resourceassignment.md)
- [Závislost projektového úkolu](../developer/entities/msdyn_projecttaskdependency.md)
- [Rezervovatelné zdroje](../developer/entities/bookableresource.md)

Chcete-li definovat strukturovaný rozpis prací s načtenými zdroji, je třeba provést následující kroky:

1. Vytvořte nový projekt. Další informace o vytvoření nového projektu naleznete v tématu [msdyn_project](../developer/entities/msdyn_project.md).
2. Vytvořte jeden nebo více úkolů. Další informace o vytvoření nového úkolu naleznete v tématu [msdyn_projecttask](../developer/entities/msdyn_projecttask.md).
3. Definujte závislosti mezi úkoly. Další informace viz [Závislost projektového úkolu](../developer/entities/msdyn_projecttaskdependency.md).
4. Přiřaďte členy projektového týmu k projektu. Další informace naleznete v tématu [msdyn_projectteam](../developer/entities/msdyn_projectteam.md).
5. Přiřaďte členy projektového týmu k úkolům. Další informace naleznete v tématu [msdyn_resourceassignment](../developer/entities/msdyn_resourceassignment.md).
