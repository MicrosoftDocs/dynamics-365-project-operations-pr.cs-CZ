...
## <a name="using-journals-to-record-costs"></a>Použití deníků k zaznamenání nákladů

V PSA vám deníky umožňují zaznamenávat náklady nebo výnosy do tříd materiálu, poplatků, času, výdajů nebo daňových transakcí. Deník obsahuje hlavičku, řádky a akci **Potvrzení**. Zde jsou některé scénáře, ve kterých můžete použít deník:
