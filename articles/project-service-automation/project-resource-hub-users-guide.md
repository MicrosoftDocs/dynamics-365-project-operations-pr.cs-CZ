...
[!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Instalace aplikace Dynamics 365 pro telefony a tablety](../mobile-app/install-dynamics-365-for-phones-and-tablets.md).
...
[!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Příručka se základy používání mobilní aplikace](../mobile-app/dynamics-365-phones-tablets-users-guide.md).
